...
class StockChartExample2 extends StatefulWidget {
  const StockChartExample2({super.key});

  @override
  _StockChartExampleState createState() => _StockChartExampleState();
}

class _StockChartExampleState extends State<StockChartExample2> {
  final List<Color> _gradientColors = [
    const Color(0xFF03A9F4),
    const Color(0xFF03A9F4),
    const Color(0xFF03A9F4),
  ];
  final int _divider = 50;
  ...
  void _prepareStockData() async {
    final List<Datum2> data = await loadStockData2();
    print(loadStockData2());
