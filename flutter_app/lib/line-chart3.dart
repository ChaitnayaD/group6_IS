...
class StockChartExample3 extends StatefulWidget {
  const StockChartExample3({super.key});

  @override
  _StockChartExampleState createState() => _StockChartExampleState();
}

class _StockChartExampleState extends State<StockChartExample3> {
  ...
  void _prepareStockData() async {
    final List<Datum3> data = await loadStockData3();
    print(loadStockData3());
